...
class UserHomeScreenViewModel @Inject constructor(
    ...
    val shopList = mutableStateListOf<lol.xget.groceryapp.seller.mainSeller.domain.ShopModel>()
    val currentItem = mutableStateOf(lol.xget.groceryapp.seller.mainSeller.domain.ShopModel())
