...
fun EditProductScreen(
    ...
    Box(
            ...
            Column(
                ...
                Column(
                    ...
                    Column(
                        ...
                        viewModel.currentProduct.value = ProductModel(
                            productPhoto = if(productImage.toString().isNullOrEmpty()) productPhotoFromVm else productImage.toString(),
        ...
        if (viewModel.state.value.successUpdated) {
            buttomVisible = false
            if (viewModel.state.value.successUpdated) LaunchedEffect(viewModel.state.value.successUpdated){ navController?.navigate(Screen.SellerHomeScreen.route) }
