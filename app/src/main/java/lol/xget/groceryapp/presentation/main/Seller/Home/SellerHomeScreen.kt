            ...
            Row(
                ...
                Column {
                    Row(
                        ...
                        IconButton(
                            onClick = {
                                navController.navigate(Screen.SellerAddProductScreen.route)
        ...
        Column {
            ...
            ProductBottomSheetDetail(
                ...
                onDetailClick = {
                    ...
                    navController.navigate(Screen.SellerEditProductScreen.route + "/${viewModel.currentItem.value.productId!!}")
                }
            )
