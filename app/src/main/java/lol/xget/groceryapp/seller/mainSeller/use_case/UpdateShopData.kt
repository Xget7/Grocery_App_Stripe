...
import lol.xget.groceryapp.seller.profileSeller.presentation.SellerProfileState
...
class UpdateShopData @Inject constructor(
    ...
    operator fun invoke (user: lol.xget.groceryapp.user.mainUser.domain.User, shopPhoto : Uri?): Flow<Resource<SellerProfileState>> =
        callbackFlow {
            try {
                try {
